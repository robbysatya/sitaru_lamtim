<div class="wrapper">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="text-align: center;">
                        <a href="<?= base_url('admin/kkpr_NonBerusaha/BelumDisetujui/Detail/' . $data['id']); ?>"
                          class="btn btn-primary">Detail Data</a>
                        <button class="btn btn-success" data-toggle="modal"
                          data-target="#terimaPengajuanModal<?= $data['id']; ?>">Setujui <i
                            class="fas fa-check"></i></button>
                        <button class="btn btn-danger" data-toggle="modal"
                          data-target="#tolakPengajuanModal<?= $data['id']; ?>">Tolak <i
  ...
  <?php foreach ($kkpr_belum as $data) : ?>
  <div class="modal fade" id="terimaPengajuanModal<?= $data['id']; ?>" tabindex="-1"
    aria-labelledby="terimaPengajuanLabel" aria-hidden="true">
        ...
        <form action="<?= base_url('admin/kkpr_NonBerusaha/BelumDisetujui/terima') ?>" method="post">
          <div class="modal-body">
            ...
            <input type="text" class="form-control" id="no_dokumen" name="no_dokumen"
              placeholder="Masukan Nomor Dokumen" required>
            <input type="text" class="form-control" id="id" name="id" placeholder="ID" required
              value="<?= $data['id']; ?>" hidden>
            <input type="text" class="form-control" id="nik" name="nik" placeholder="NIK" required
              value="<?= $data['nik']; ?>" hidden>
          </div>
  ...
  <?php foreach ($kkpr_belum as $data) : ?>
  <div class="modal fade" id="tolakPengajuanModal<?= $data['id']; ?>" tabindex="-1"
    aria-labelledby="tolakPengajuanLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <form action="<?= base_url('admin/kkpr_NonBerusaha/BelumDisetujui/tolak') ?>" method="post">
          <div class="modal-body">
            ...
            <input type="text" class="form-control" id="alasan" name="alasan"
              placeholder="Alasan Ditolak (Kosongkan jika tidak ada)">
            <input type="text" class="form-control" id="nik" name="nik" placeholder="NIK" required value="
<?= $data['nik']; ?>" hidden>
          </div>
