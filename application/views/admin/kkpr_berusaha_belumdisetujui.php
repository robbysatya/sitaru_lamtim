                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="text-align: center;">
                        <a href="<?= base_url('admin/kkpr_Berusaha/BelumDisetujui/Detail/' . $data['id']); ?>"
        ...
        <form action="<?= base_url('admin/kkpr_Berusaha/BelumDisetujui/terima') ?>" method="post">
          <div class="modal-body">
            ...
            <input type="text" class="form-control" id="no_berkas" name="no_berkas"
              placeholder="Masukan Kode Nomor Berkas">
      ...
      <div class="modal-content">
        ...
        <form action="<?= base_url('admin/kkpr_Berusaha/BelumDisetujui/tolak') ?>" method="post">
          <div class="modal-body">
            ...
            <input ty
pe="text" class="form-control" id="nik" name="nik" placeholder="NIK" required
              value="<?= $data['nik']; ?>" hidden>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fas fa-fw fa-times"></i>
