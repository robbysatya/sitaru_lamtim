            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-responsive">
                  <a href="<?= base_url('admin/KKPR_NonBerusaha/BelumDisetujui/'); ?>" class="btn btn-link"><i
                    ...
                    <tr>
                      <td colspan="2">
                        ...
                        <button class="btn btn-danger" data-toggle="modal"
                          data-target="#tolakPengajuanModal<?= $data['id']; ?>">Tolak <i class="fas fa-times">
                      </td>
                    </tr>
                    <?php endforeach; ?>
                  </tbody>
    ...
    <div class="modal-dialog modal-dialog">
      <div class="modal-content">
        ...
        <form action="<?= base_url('admin/kkpr_NonBerusaha/BelumDisetujui/terima') ?>" method="post">
          ...
          <div class=
"modal-footer">
            <button t ype="button" class="btn btn-secondary" data-dismiss="modal"><i class="fas fa-fw fa-times"></i>
              No</button>
