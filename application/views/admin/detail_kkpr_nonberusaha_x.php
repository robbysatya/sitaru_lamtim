						...
						<div class="card">
							...
							<div class="card-body">
								<table id="example1" class="table table-bordered table-responsive">
									<a href="<?= base_url('admin/KKPR_NonBerusaha/BelumDisetujui/'); ?>" class="btn btn-link"><i class="fas fa-arrow-left"></i> Kembali</a>
									<tbody>
										<?php foreach ($kkpr_belum as $data) : ?>
											...
											<tr>
												...
												<td> <a class="btn btn-info" target="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_permohonan_bermaterai']; ?>" href="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_permohonan_bermaterai']; ?>">
											...
											<tr>
												...
												<td> <a class="btn btn-info" target="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_ktp_pemohon']; ?>" href="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_ktp_pemohon']; ?>">
														<i class="fas fa-eye"></i> Lihat Berkas
													</a>
												</td>
											</tr>
											<tr>
												...
												<td> <a class="btn btn-info" target="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_bukti_penguasaan_tanah']; ?>" href="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_bukti_penguasaan_tanah']; ?>">
														<i class="fas fa-eye"></i> Lihat Berkas
													</a>
												</td>
											</tr>
											<tr>
												...
												<td> <a class="btn btn-info" target="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_surat_keterangan_waris']; ?>" href="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_surat_keterangan_waris']; ?>">
														<i class="fas fa-eye"></i> Lihat Berkas
													</a>
												</td>
											</tr>
											<tr>
												...
												<td> <a class="btn btn-info" target="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_dokumen_perjanjian_sewa']; ?>" href="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_dokumen_perjanjian_sewa']; ?>">
														<i class="fas fa-eye"></i> Lihat Berkas
													</a>
												</td>
											</tr>
											<tr>
												...
												<td> <a class="btn btn-info" target="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_dokumen_akta_jual_beli']; ?>" href="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_dokumen_akta_jual_beli']; ?>">
														<i class="fas fa-eye"></i> Lihat Berkas
													</a>
												</td>
											</tr>
											<tr>
												...
												<td> <a class="btn btn-info" target="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_surat_pernyataan_pemohon']; ?>" href="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_surat_pernyataan_pemohon']; ?>">
														<i class="fas fa-eye"></i> Lihat Berkas
													</a>
												</td>
											</tr>
											<tr>
												...
												<td> <a class="btn btn-info" target="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_polygon_koordinat']; ?>" href="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_polygon_koordinat']; ?>">
														<i class="fas fa-eye"></i> Lihat Berkas
													</a>
												</td>
											</tr>
											<tr>
												<th>Rencana Penggunaan Air Baku / Air bersih + Rencana Teknis Bangunan (RTB) / Rencana Induk
													Kawasan (RIK)</th>
												<td> <a class="btn btn-info" target="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_rencana_penggunaan_air']; ?>" href="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_rencana_penggunaan_air']; ?>">
														<i class="fas fa-eye"></i> Lihat Berkas
													</a>
												</td>
											</tr>
											<th>Dokumen Perizinan Sebelumnya (AP/KRK/IPPT/ Rekomendasi Teknis Lainnya)</th>
											<td> <a class="btn btn-info" target="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_dokumen_perizinan_sebelumnya']; ?>" href="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_dokumen_perizinan_sebelumnya']; ?>">
													<i class="fas fa-eye"></i> Lihat Berkas
												</a>
											</td>
											</tr>
											...
											<td> <a class="btn btn-info" target="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_kepentingan_umum']; ?>" href="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_kepentingan_umum']; ?>">
													<i class="fas fa-eye"></i> Lihat Berkas
												</a>
											</td>
											</tr>
											...
											<tr>
												...
												<td> <a class="btn btn-info" target="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_gambar_sisi_utara']; ?>" href="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_gambar_sisi_utara']; ?>">
														<i class="fas fa-eye"></i> Lihat Berkas
													</a>
												</td>
											</tr>
											<tr>
												...
												<td> <a class="btn btn-info" target="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_gambar_sisi_selatan']; ?>" href="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_gambar_sisi_selatan']; ?>">
														<i class="fas fa-eye"></i> Lihat Berkas
													</a>
												</td>
											</tr>
											<tr>
												...
												<td> <a class="btn btn-info" target="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_gambar_sisi_barat']; ?>" href="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_gambar_sisi_barat']; ?>">
														<i class="fas fa-eye"></i> Lihat Berkas
													</a>
												</td>
											</tr>
											<tr>
												...
												<td> <a class="btn btn-info" target="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_gambar_sisi_timur']; ?>" href="<?= base_url('assets/file/kkpr_nonberusaha/') . $data['file_gambar_sisi_timur']; ?>">
														<i class="fas fa-eye"></i> Lihat Berkas
													</a>
												</td>
											</tr>
											...
											<tr>
												<td colspan="2">
													<a href="<?= base_url('admin/kkpr_NonBerusaha/BelumDisetujui/'); ?>" class="btn btn-primary"><i class="fas fa-arrow-left"></i> Kembali</a>
		...
		<div class="modal fade" id="tolakPengajuanModal<?= $data['id']; ?>" tabindex="-1" aria-labelledby="tolakPengajuanLabel" aria-hidden="true">
			<div class="modal-dialog modal-dialog">
				<div class="modal-content">
					...
					<form action="<?= base_url('admin/kkpr_NonBerusaha/BelumDisetujui/tolak') ?>" method="post">
						<div class="modal-body">
