  				...
  				<div class="col-md-12">
  					<div class="card card-default">
  						...
  						<div class="card-body m-0">
  							<form method="POST" action="<?= base_url('perizinan/kkpr_NonBerusaha/ajukan') ?>" enctype="multipart/form-data">
  								...
  								<div class="form-group">
  									...
  									<input required type="text" name="luas_tanah_dimohon" class="form-control" id="luas_tanah_dimohon" placeholder="Luas Tanah Dimohon"></input>
  								</div>
  								<div class="form-group">
  									...
  									<input required type="text" name="luas_tanah_sesuai_bukti" class="form-control" id="luas_tanah_sesuai_bukti" placeholder="Luas Sesuai Bukti Kepemilikan Tanah"></input>
  								</div>
  								<div class="form-group">
  									<label for="exampleInputLuasBangunan"><span class="text-danger">*</span> Luas Bangunan <span class="text-danger">m<sup>2</sup></span></label>
  									<input required type="text" name="luas_bangunan" class="form-control" id="luas_bangunan" placeholder="Luas Bangunan"></input>
  								</div>
  								...
  								<div class="form-group">
  									...
  									<div class="input-group">
  										<div class="custom-file">
  											<input type="file" accept=" application/pdf,image/jpeg,image/jpg,image/png" class="custom-file-input" id="file_ktp_pemohon" name="file_ktp_pemohon">
  											<label class="custom-file-label" for="exampleInputFile">Choose file</label>
  										</div>
  									</div>
  								</div>
  								...
  								<div class="form-group">
  									...
  									<div class="input-group">
  										<div class="custom-file">
  											<input type="file" accept=".zip, .rar" class="custom-file-input" id="file_polygon_koordinat" name="file_polygon_koordinat">
  											<label class="custom-file-label" for="exampleInputFile">Choose file</label>
  										</div>
  									</div>
  								</div>
  								...
  								<div class="form-group">
  									...
  									<div class="input-group">
  										<div class="custom-file">
  											<input type="file" accept=" application/pdf,image/jpeg,image/jpg,image/png" class="custom-file-input" id="file_kepentingan_umum" name="file_kepentingan_umum">
  											<label class="custom-file-label" for="exampleInputFile">Choose file</label>
  										</div>
  									</div>
  								</div>
