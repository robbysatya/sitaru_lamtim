    ...
    <section id="form" class="d-flex align-items-center">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h3><span>Formulir KKPR Non Berusaha</span></h3>
          <p>Pengajuan Kesesuaian Kegiatan Pemanfaatan Ruang Non Berusaha :</p>
        </div>
            ...
            <div class="card card-default">
              <div class="card-header ">
                ...
                <ul class="list-group">
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    2. Fotokopi KTP Pemohon + Surat Kuasa + Fc yang diberi kuasa (apabila yang mengurus bukan pemilik
                    tanah)
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    3. Bukti Penguasaan Tanah (SHM / SHGB / SHGU / SHP / Wakaf / HPL/ Letter C+Peta Bidang)
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    4. Surat Keterangan Waris (bila pemilik meninggal dunia)
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    5. Dokumen Perjanjian Sewa Menyewa
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    6. Dokumen Akta Jual Beli dan Surat Pernyataan Pemilik Tanah
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    7. Surat Pernyataan Pemohon Bermeterai
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    8. Rencana Penggunaan Air Baku / Air bersih + Rencana Teknis Bangunan (RTB) / Rencana Induk Kawasan
                    (RIK)
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    9. Dokumen Perizinan Sebelumnya (AP/KRK/IPPT/ Rekomendasi Teknis Lainnya)
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    10. Surat Keterangan Untuk Kepentingan Umum
                  </li>
                </ul>
              </div>
              <div class="card-body m-0">
                <form method="POST" action="<?= base_url('perizinan/kkpr_NonBerusaha/ajukan') ?>"
                  ...
                  <div class="form-group">
                    ...
                    <input minlength="16" required type="number" name="nik" class="form-control" id="nik"
                      placeholder="Nomor Induk Kependudukan" value="<?= $user['nik'] ?>" readonly>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputNama"><span class="text-danger">*</span> Nama Pemohon</label>
                    <input required type="text" name="nama" class="form-control" id="nama" placeholder="Nama Pemohon"
                  ...
                  <div class="form-group">
                    ...
                    <input required type="text" name="pekerjaan" class="form-control" id="pekerjaan"
                      placeholder="Pekerjaan Pemohon" value="<?= $user['pekerjaan'] ?>" readonly>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input required type="text" name="no_hp" class="form-control" id="no_hp"
                      placeholder="Contoh : 081234567898" value="<?= $user['no_hp'] ?>" readonly>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputAlamat"><span class="text-danger">*</span> Alamat Pemohon</label>
                    <textarea required type="text" name="alamat_pemohon" class="form-control" id="alamat_pemohon"
                      placeholder="Jl. Nama Jalan, Desa/Kelurahan, Kecamatan, Kabupaten"></textarea>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputFungsi"><span class="text-danger">*</span> Fungsi</label>
                    <textarea required type="text" name="fungsi_bangunan" class="form-control" id="fungsi_bangunan"
                      placeholder="Fungsi Kegiatan Pemanfaatan Ruang nantinya digunakan untuk..."></textarea>
                  </div>

                  <!-- STEP 2 -->
                  <hr style="border: 0.5px solid #000;">
                  <h2 class="py-4">Lokasi Kegiatan</h2>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="exampleInputLuasTanahDimohon"><span class="text-danger">*</span> Luas Tanah Dimohon
                      <span class="text-danger">m<sup>2</sup></span></label>
                    <input required type="text" name="luas_tanah_dimohon" class="form-control" id="luas_tanah_dimohon"
                      placeholder="Luas Tanah Dimohon"></input>
                  </div>
                  <div class="form-group">
                    ...
                    <input required type="text" name="luas_tanah_sesuai_bukti" class="form-control"
                      id="luas_tanah_sesuai_bukti" placeholder="Luas Sesuai Bukti Kepemilikan Tanah"></input>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputLuasBangunan"><span class="text-danger">*</span> Luas Bangunan <span
                        class="text-danger">m<sup>2</sup></span></label>
                    <input required type="text" name="luas_bangunan" class="form-control" id="luas_bangunan"
                      placeholder="Luas Bangunan"></input>
                  </div>
                  ...
                  <div class="form-group">
                    <label for="exampleInputPenggunaanTanahSekarang"><span class="text-danger">*</span> Penggunaan Tanah
                      Sekarang</label>
                    <textarea required type="text" name="penggunaan_tanah_sekarang" class="form-control"
                      id="penggunaan_tanah_sekarang" placeholder="Penggunaan Tanah Sekarang"></textarea>
                  </div>

                  <div class="form-group">
                    <label for="exampleInputRencanaJumlahLantai"><span class="text-danger">*</span> Rencana Jumlah
                      Lantai</label>
                    <input required type="number" name="rencana_jumlah_lantai" class="form-control"
                      id="rencana_jumlah_lantai" placeholder="Rencana Jumlah Lantai"></input>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input required type="number" name="rencana_tinggi_bangunan" class="form-control"
                      id="rencana_tinggi_bangunan" placeholder="Rencana Tinggi Bangunan"></input>
                  </div>

                  <div class="form-group">
                    <label for="exampleInputRencanaTotalLuasLantai"><span class="text-danger">*</span> Rencana Total
                      Luas Lantai <span class="text-danger">m<sup>2</sup></span></label>
                    <input required type="number" name="rencana_total_luas_lantai" class="form-control"
                      id="rencana_total_luas_lantai" placeholder="Rencana Total Luas Lantai"></input>
                  </div>
                  ...
                  <div class="form-group">
                    <label for="exampleInputFile">Fotokopi KTP Pemohon + Surat Kuasa + Fc yang diberi kuasa (apabila
                      yang mengurus bukan pemilik tanah)</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" accept=" application/pdf,image/jpeg,image/jpg,image/png"
                          class="custom-file-input" id="file_ktp_pemohon" name="file_ktp_pemohon">
                        <label class="custom-file-label" for="exampleInputFile">Choose file</label>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" accept=" application/pdf,image/jpeg,image/jpg,image/png"
                          class="custom-file-input" id="file_dokumen_perjanjian_sewa"
                  ...
                  <div class="form-group">
                    <label for="exampleInputFile">Polygon Koordinat Lokasi Dimohon (format *.kmz atau *.kml atau *.shp
                      dlm bentuk zip)</label>
                    <div class="input-group">
                      <div class="custom-file">
                  ...
                  <div class="form-group">
                    <label for="exampleInputFile">Rencana Penggunaan Air Baku / Air bersih + Rencana Teknis Bangunan
                      (RTB) / Rencana Induk Kawasan (RIK)</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" accept=" application/pdf,image/jpeg,image/jpg,image/png"
                  ...
                  <div class="form-group">
                    <label for="exampleInputFile">Surat Keterangan Untuk Kepentingan Umum</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" accept=" application/pdf,image/jpeg,image/jpg,image/png"
                          class="custom-file-input" id="file_kepentingan_umum" name="file_kepentingan_umum">
                        <label class="custom-file-label" for="exampleInputFile">Choose file</label>
                      </div>
                    </div>
                  </div>
                        ...
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" accept=".jpg, .jpeg. .png" class="custom-file-input"
                              id="file_gambar_sisi_utara" name="file_gambar_sisi_utara">
                            <label class="custom-file-label" for="exampleInputFile">Choose file</label>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" accept=".jpg, .jpeg. .png" class="custom-file-input"
                              id="file_gambar_sisi_selatan" name="file_gambar_sisi_selatan">
                            <label class="custom-file-label" for="exampleInputFile">Choose file</label>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" accept=".jpg, .jpeg. .png" class="custom-file-input"
                              id="file_gambar_sisi_barat" name="file_gambar_sisi_barat">
                            <label class="custom-file-label" for="exampleInputFile">Choose file</label>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <div class="custom-file">
                            ...
                            <input type="file" accept=".jpg, .jpeg. .png" class="custom-file-input"
                              id="file_gambar_sisi_timur" name="file_gambar_sisi_timur">
                            <label class="custom-file-label" for="exampleInputFile">Choose file</label>
                          </div>
                        </div>
                      </div>
