        ...
        <div class="col-md-12">
          <div class="card card-default">
            ...
            <div class="card-body m-0">
              <form class="berusaha" method="POST" action="<?= base_url('perizinan/kkpr_Berusaha/ajukan') ?>"
                ...
                <div class="form-group">
                  ...
                  <input required type="" name="nama_kegiatan" class="form-control" id="nama_kegiatan"
                    placeholder="Nama Kegiatan Usaha">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input required type="" name="kbli_judul" class="form-control" id="kbli_judul"
                    placeholder="KBLI Judul">
                </div>
                <div class="form-group">
                  <label for="exampleInputSkalaUsaha"><span class="text-danger">*</span> Skala Usaha</label>
                  <select data-placeholder="Skala Usaha" class="form-control" aria-label="Default select example"
                ...
                <div class="form-group">
                  <label for="exampleInputLuasTanahDimohon"><span class="text-danger">*</span> Luas Tanah Dimohon <span
                      class="text-danger">m<sup>2</sup></span></label>
                  <input required type="" name="luas_tanah_dimohon" class="form-control" id="luas_tanah_dimohon"
                ...
                <div class="form-group">
                  ...
                  <input required type="" name="luas_tanah_sesuai_bukti" class="form-control"
                ...
                <div class="form-group">
                  ...
                  <input required type="" name="luas_bangunan" class="form-control" id="luas_bangunan"
                ...
                <div class="form-group">
                  <label for="exampleInputRencanaJumlahLantai"><span class="text-danger">*</span> Rencana Jumlah
                    Lantai</label>
                  <input required type="text" name="rencana_jumlah_lantai" class="form-control"
                ...
                <div class="form-group">
                  ...
                  <input required type="text" name="rencana_tinggi_bangunan" class="form-control"
                ...
                <div class="form-group">
                  ...
                  <input required type="text" name="rencana_total_luas_lantai" class="form-control"
